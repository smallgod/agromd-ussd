...
public enum MenuName implements Constants {
    ...
    BUYER_SELLER_LIST("BUYER_SELLER_LIST"),
    ...
    FARMING_TIPS_CHAPTERS("FARMING_TIPS_CHAPTERS"),
    FARMING_TIPS_TOPICS("FARMING_TIPS_TOPICS"),
    FARMING_TIPS_CATEGORY("FARMING_TIPS_CATEGORY"),
    FARMING_TIPS_CONTENT("FARMING_TIPS_CONTENT"),
    ...
    MARKET_DISTRICT_PRICES("MARKET_DISTRICT_PRICES"),
    BUYER_SELLER_DISTRICTS("BUYER_SELLER_DISTRICTS"),
